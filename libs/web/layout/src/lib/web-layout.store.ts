...
import { WebAuthStore } from '@demo/web/auth/data-access'
import { Role } from '@demo/web/core/data-access'
...
{ label: 'Reporters', route: 'reporters' },
{ label: 'Companys', route: 'companys' },
